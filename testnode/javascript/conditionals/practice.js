...
var passwordStrength = function (password) {
  if (password.length>= 10){
    ...
    return "loosely strong password";
  }
  else{
...
console.log(passwordStrength("efeerfergrcx"));
...
console.log(firstInDictionary('siva',0, 'ravi'));
...
console.log(getTagName("<div>jsidsjfd</div>"));
...
// practice problem.
var isQuestion = function (que) {
  var QUESTION ="?";
  var last_element=que.charAt(que.length-1);
  return last_element== QUESTION;
};
console.log(isQuestion("why?"));
...
//     magic8Ball("you suck");
//     //=> THAT DOESN'T SOUND LIKE A QUESTI0N!
//
...
var magic8Ball = function (question) {
 ...
 if(q != "?")
 {
   throw "IT DOESN'T SOUND LIKE A QUESTION!"
 }
 else
 {
