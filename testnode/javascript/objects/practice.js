...
console.log(isUser({ "name":"Firstname Lastname", "screen_name":"user" }))
...
if(isUser(obj)){
return "<div><h1>" + Object.values(obj)[0] + "</h1><h2>" + Object.values(obj)[1] +"</h1></div>";
}
else{
...
return "<div><h1>" + Object.values(obj)[0] + "</h1><h2>" + Object.values(obj)[1] +"</h1><ul>" + tweetsInAList + "</ul></div>";
}
else{
