...
var StartZ = names.forEach(function(name){
var Zn = 0;
  if(name[0]==="z"){
    Zn += 1;
  }
...
var ZinName = 0;
var NamesWithZ = names.forEach(function(item){
...
var namesStartWithUpperW = names.filter(function(name){
return name[0] === "W";
})
console.log(namesStartWithUpperW);
=> []
...
var VowelChek = names.every(function(name){
  atLeastOneVowel(name);
});
...
var twoLetterNames = names.some(function(name){
...
var isMyNameInList = names.some(function(name){
return name === "vnay";
})
console.log(isMyNameInList);
=> false



7. Find the name that would come first alphabetically.
var firstNameAlhabetically = names.sort()[0];
console.log(firstNameAlhabetically);
=> aaden
...
var zCount = 0;
var zRepetition = names.forEach(function(name){
if(name.indexOf("z") >= 0){
zCount += 1;
}
return zCount;
...
=> 65
//how to detect if there are more than 1 repetitions of 'z' in a single name??//
