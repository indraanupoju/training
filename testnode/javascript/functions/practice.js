...
//     //=> queen of hearts
var cardString = function (i,j) {
  return i +' of ' + j;
};
var NewString =cardString("bay","bangal");
...
var toTagString = function (c,d) {
  return c + 'paragragh' + d ;
};

var  Total =toTagString ("<p>","</p>");
console.log(Total);
