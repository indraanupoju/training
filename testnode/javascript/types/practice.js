...
// `/`.
var celsToFahr = function (n) {
  return ((n*9)/5+32);
};
console.log(celsToFahr(126));
...
var randBetween = function (b) {
  return Math.floor(Math.random());
};
  console.log(randBetween(2));
...
if( suit.toLowerCase() == "clubs" || suit.toLowerCase() == "diamonds" || suit.toLowerCase() == "sprades"|| suit.toLowerCase() == "hearts")
{
  return true;
}
 else{
...
//     //=> this is a list item
var getHTMLText = function (txt) {
return txt.slice(txt.indexOf('>')+1,txt.lastIndexOf('<'));

  };

  console.log (getHTMLText("<p>kumar</p>"));
...
console.log(isHTMLElement("<p>indrbjda</p>"));
console.log(isHTMLElement("<p>blahblahuh</DIV>"));
console.log(isHTMLElement("<pblahblahd<p>"));
